...
SECRET_KEY = 'django-insecure-xksi@3(un!&6xhyfn1-#0#tl=s&$a-y*vwu%i=4$vuu2r*chc)'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ro.meddraddo@gmail.com'
EMAIL_HOST_PASSWORD = 'wgjieranppbmwydw'